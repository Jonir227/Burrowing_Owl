        ...
        return (
            <Resizable onResize={this.onResize}>
                <div style = {{ position:'absolute', width : this.state.width, height : this.state.height}} >
                        <img src = './image/image2.svg' style = {{width: this.state.width, height:this.state.height}}/>
                        ...
                        <img src = './image/image3.svg' style = {{position : 'absolute', visibility : this.state.visibility, 
                            width : this.state.width * 0.3, height : this.state.height * 0.3, top : this.state.height * 0.32, left : this.state.width * 0.52}}/>
                        <Link to = "/Window">
